...
apt install -y php8.2 php8.2-cli php8.2-fpm php8.2-gd php8.2-gnupg php8.2-xml php8.2-mbstring php8.2-zip php8.2-gettext php8.2-soap php8.2-curl php8.2-mysql php8.2-zmq libapache2-mod-php8.2
